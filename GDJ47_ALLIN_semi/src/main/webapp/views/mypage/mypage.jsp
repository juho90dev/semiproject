...
%> 
  ...
  <div class="outer">
		...
		<a href="<%=request.getContextPath() %>/requestList.do?plannerId=<%=m.getUserId()%>">주문 받은 플랜 내역</a><br><br>
		<a href="<%=request.getContextPath() %>/customerpage.do?memberId=<%=m.getUserId()%>">주문한 플랜 내역</a><br><br>
